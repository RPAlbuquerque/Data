...
Original file is located at
    https://colab.research.google.com/drive/1q3v_RG6rqCDZoba1wTKB7L5Xp_7q61lF
"""
...
if indice < len(perguntas):
    ...
    avancar = st.button("Próxima pergunta")
    if avancar:
        if escolha:
            ...
            st.experimental_set_query_params(step=st.session_state.indice)
            st.stop()
        else:
