...
Original file is located at
    https://colab.research.google.com/drive/1gQYtl2N3JoJwgCwg-YUznpMIkDQFvz4W
"""
...
st.markdown("<h3 style='text-align: center;'>Vamos avaliar o nível de Marketing Estratégico da sua empresa?</h3>", unsafe_allow_html=True)
st.markdown("---")
...
# Sessão de estado para controle de perguntas e pontuação
...
if indice < len(perguntas):
    ...
    if escolha and st.button("Próxima pergunta"):
